...
function Search() {
  return (
    <form className="flex items-center justify-center bg-gray-100 py-4  ">
        <input
        ...
        <button className="transition justify-center w-16 h-8 text-md rounded  hover:bg-gray-900 hover:text-white" type="submit">Search</button>
    </form> 
    );
  }
