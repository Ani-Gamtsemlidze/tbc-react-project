...
const SideBar = () => {
  return (
    <div className="min-h-screen w-screen bg-gray-50 z-50 absolute  lg:hidden">
      <div className="absolute left-0 flex h-screen w-72 flex-col overflow-hidden rounded-r-2xl bg-mainColor text-black">
        <Logo />
        <ul className="mt-20 space-y-3">
          <li className="relative flex cursor-pointer space-x-2 rounded-md py-4 px-10 text-black hover:bg-slate-600">
            <Navigation />
            {/* <span>
              <svg
