    ...
    <div className="flex  dark:border-[#B85042] dark:border-t items-center justify-center dark:bg-slate-700  ">
      <div className="relative ">
        <div
          ...
          className="transition text-sm hover:bg-#E895D0 hover:placeholder-[#16442a] hover:text-[#16442a]  border-[rgb(122,122,122)]  rounded-lg border cursor-pointer py-3 px-10 bg-transparent placeholder-black focus:outline-none text-black "
        >
          {t("search")}
        </div>
